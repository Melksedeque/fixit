...
import { Mail, Phone, Calendar, Shield, CheckCircle2, Clock, AlertCircle, FileText, Eye } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-8 lg:col-span-9 space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Meus Últimos Chamados</CardTitle>
              <CardDescription>Últimos 5 chamados {isTechOrAdmin ? "atendidos por" : "abertos por"} você.</CardDescription>
            </CardHeader>
            <CardContent>
              {tickets.length > 0 ? (
